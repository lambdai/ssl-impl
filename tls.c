...
static CipherSuite suites[] = {
    ...
    {TLS_RSA_WITH_NULL_SHA, 0, 0, 0, SHA1_BYTE_SIZE, NULL, NULL,
     new_sha1_digest},
    ...
    {TLS_RSA_EXPORT_WITH_DES40_CBC_SHA, 0, 0, 0, SHA1_BYTE_SIZE, NULL, NULL,
     new_sha1_digest},
    {TLS_RSA_WITH_DES_CBC_SHA, 8, 8, 8, SHA1_BYTE_SIZE, des_encrypt,
     des_decrypt, new_sha1_digest},
    {TLS_RSA_WITH_3DES_EDE_CBC_SHA, 8, 8, 24, SHA1_BYTE_SIZE, des3_encrypt,
     des3_decrypt, new_sha1_digest},
    {TLS_DH_DSS_EXPORT_WITH_DES40_CBC_SHA, 0, 0, 0, SHA1_BYTE_SIZE, NULL, NULL,
     new_sha1_digest},
    {TLS_DH_DSS_WITH_DES_CBC_SHA, 0, 0, 0, SHA1_BYTE_SIZE, NULL, NULL,
     new_sha1_digest},
    {TLS_DH_DSS_WITH_3DES_EDE_CBC_SHA, 8, 8, 24, SHA1_BYTE_SIZE, des3_encrypt,
     des3_decrypt, new_sha1_digest},
    {TLS_DH_RSA_EXPORT_WITH_DES40_CBC_SHA, 0, 0, 0, SHA1_BYTE_SIZE, NULL, NULL,
     new_sha1_digest},
    {TLS_DH_RSA_WITH_DES_CBC_SHA, 0, 0, 0, SHA1_BYTE_SIZE, NULL, NULL,
     new_sha1_digest},
    {TLS_DH_RSA_WITH_3DES_EDE_CBC_SHA, 0, 0, 0, SHA1_BYTE_SIZE, NULL, NULL,
     new_sha1_digest},
    {TLS_DHE_DSS_EXPORT_WITH_DES40_CBC_SHA, 0, 0, 0, SHA1_BYTE_SIZE, NULL, NULL,
     new_sha1_digest},
    {TLS_DHE_DSS_WITH_DES_CBC_SHA, 0, 0, 0, SHA1_BYTE_SIZE, NULL, NULL,
     new_sha1_digest},
    {TLS_DHE_DSS_WITH_3DES_EDE_CBC_SHA, 0, 0, 0, SHA1_BYTE_SIZE, NULL, NULL,
     new_sha1_digest},
    {TLS_DHE_RSA_EXPORT_WITH_DES40_CBC_SHA, 0, 0, 0, SHA1_BYTE_SIZE, NULL, NULL,
     new_sha1_digest},
    {TLS_DHE_RSA_WITH_DES_CBC_SHA, 8, 8, 8, SHA1_BYTE_SIZE, des_encrypt,
     des_decrypt, new_sha1_digest},
    {TLS_DHE_RSA_WITH_3DES_EDE_CBC_SHA, 0, 0, 0, SHA1_BYTE_SIZE, NULL, NULL,
     new_sha1_digest},
    {TLS_DH_anon_EXPORT_WITH_RC4_40_MD5, 0, 0, 0, MD5_BYTE_SIZE, NULL, NULL,
     new_md5_digest},
    {TLS_DH_anon_WITH_RC4_128_MD5, 0, 0, 0, MD5_BYTE_SIZE, NULL, NULL,
     new_md5_digest},
    {TLS_DH_anon_EXPORT_WITH_DES40_CBC_SHA, 0, 0, 0, SHA1_BYTE_SIZE, NULL, NULL,
     new_sha1_digest},
    {TLS_DH_anon_WITH_DES_CBC_SHA, 0, 0, 0, SHA1_BYTE_SIZE, NULL, NULL,
     new_sha1_digest},
    {TLS_DH_anon_WITH_3DES_EDE_CBC_SHA, 0, 0, 0, SHA1_BYTE_SIZE, NULL, NULL,
     new_sha1_digest},
    {TLS_KRB5_WITH_DES_CBC_SHA, 0, 0, 0, SHA1_BYTE_SIZE, NULL, NULL,
     new_sha1_digest},
    {TLS_KRB5_WITH_3DES_EDE_CBC_SHA, 0, 0, 0, SHA1_BYTE_SIZE, NULL, NULL,
     new_sha1_digest},
    {TLS_KRB5_WITH_RC4_128_SHA, 0, 0, 0, SHA1_BYTE_SIZE, NULL, NULL,
     new_sha1_digest},
    {TLS_KRB5_WITH_IDEA_CBC_SHA, 0, 0, 0, SHA1_BYTE_SIZE, NULL, NULL,
     new_sha1_digest},
    {TLS_KRB5_WITH_DES_CBC_MD5, 0, 0, 0, MD5_BYTE_SIZE, NULL, NULL,
     new_md5_digest},
    {TLS_KRB5_WITH_3DES_EDE_CBC_MD5, 0, 0, 0, MD5_BYTE_SIZE, NULL, NULL,
     new_md5_digest},
    {TLS_KRB5_WITH_RC4_128_MD5, 0, 0, 0, MD5_BYTE_SIZE, NULL, NULL,
     new_md5_digest},
    {TLS_KRB5_WITH_IDEA_CBC_MD5, 0, 0, 0, MD5_BYTE_SIZE, NULL, NULL,
     new_md5_digest},
    {TLS_KRB5_EXPORT_WITH_DES_CBC_40_SHA, 0, 0, 0, SHA1_BYTE_SIZE, NULL, NULL,
     new_sha1_digest},
    {TLS_KRB5_EXPORT_WITH_RC2_CBC_40_SHA, 0, 0, 0, SHA1_BYTE_SIZE, NULL, NULL,
     new_sha1_digest},
    {TLS_KRB5_EXPORT_WITH_RC4_40_SHA, 0, 0, 0, SHA1_BYTE_SIZE, NULL, NULL,
     new_sha1_digest},
    {TLS_KRB5_EXPORT_WITH_DES_CBC_40_MD5, 0, 0, 0, MD5_BYTE_SIZE, NULL, NULL,
     new_md5_digest},
    {TLS_KRB5_EXPORT_WITH_RC2_CBC_40_MD5, 0, 0, 0, MD5_BYTE_SIZE, NULL, NULL,
     new_md5_digest},
    {TLS_KRB5_EXPORT_WITH_RC4_40_MD5, 0, 0, 0, MD5_BYTE_SIZE, NULL, NULL,
     new_md5_digest},
    // XXX are these three defined?
    {0x002C, 0, 0, 0, 0, NULL, NULL, NULL},
    {0x002D, 0, 0, 0, 0, NULL, NULL, NULL},
    {0x002E, 0, 0, 0, 0, NULL, NULL, NULL},
    {TLS_RSA_WITH_AES_128_CBC_SHA, 16, 16, 16, SHA1_BYTE_SIZE, aes_128_encrypt,
     aes_128_decrypt, new_sha1_digest},
    {TLS_DH_DSS_WITH_AES_128_CBC_SHA, 16, 16, 16, SHA1_BYTE_SIZE,
     aes_128_encrypt, aes_128_decrypt, new_sha1_digest},
    {TLS_DH_RSA_WITH_AES_128_CBC_SHA, 16, 16, 16, SHA1_BYTE_SIZE,
     aes_128_encrypt, aes_128_decrypt, new_sha1_digest},
    {TLS_DHE_DSS_WITH_AES_128_CBC_SHA, 16, 16, 16, SHA1_BYTE_SIZE,
     aes_128_encrypt, aes_128_decrypt, new_sha1_digest},
    {TLS_DHE_RSA_WITH_AES_128_CBC_SHA, 16, 16, 16, SHA1_BYTE_SIZE,
     aes_128_encrypt, aes_128_decrypt, new_sha1_digest},
    {TLS_DH_anon_WITH_AES_128_CBC_SHA, 16, 16, 16, SHA1_BYTE_SIZE,
     aes_128_encrypt, aes_128_decrypt, new_sha1_digest},
    {TLS_RSA_WITH_AES_256_CBC_SHA, 16, 16, 32, SHA1_BYTE_SIZE, aes_256_encrypt,
     aes_256_decrypt, new_sha1_digest},
    {TLS_DH_DSS_WITH_AES_256_CBC_SHA, 16, 16, 32, SHA1_BYTE_SIZE,
     aes_256_encrypt, aes_256_decrypt, new_sha1_digest},
    {TLS_DH_RSA_WITH_AES_256_CBC_SHA, 16, 16, 32, SHA1_BYTE_SIZE,
     aes_256_encrypt, aes_256_decrypt, new_sha1_digest},
    {TLS_DHE_DSS_WITH_AES_256_CBC_SHA, 16, 16, 32, SHA1_BYTE_SIZE,
     aes_256_encrypt, aes_256_decrypt, new_sha1_digest},
    {TLS_DHE_RSA_WITH_AES_256_CBC_SHA, 16, 16, 32, SHA1_BYTE_SIZE,
     aes_256_encrypt, aes_256_decrypt, new_sha1_digest},
    {TLS_DH_anon_WITH_AES_256_CBC_SHA, 16, 16, 32, SHA1_BYTE_SIZE,
     aes_256_encrypt, aes_256_decrypt, new_sha1_digest},
};
...
static int send_message(int connection, int content_type,
                        const unsigned char *content, short content_len,
  ...
  if (active_suite->new_digest) {
    ...
    hmac(parameters->MAC_secret, active_suite->hash_size, mac_buffer,
         13 + content_len, &digest);
  ...
  if (mac) {
    memcpy(send_buffer + content_len + 5, mac,
           active_suite->hash_size + padding_length);
    free(mac);
  }
  ...
  if (active_suite->bulk_encrypt) {
    ...
    active_suite->bulk_encrypt(send_buffer + 5, send_buffer_size - 5,
                               encrypted_buffer + 5, parameters->IV,
                               parameters->key);
    free(send_buffer);
...
static int send_alert_message(int connection, int alert_code,
                              ProtectionParameters *parameters) {
  char buffer[2];
...
static int send_handshake_message(int connection, int msg_type,
  ...
  response =
      send_message(connection, content_handshake, send_buffer, send_buffer_size,
...
/**
 6.3: Compute a key block, including MAC secrets, keys, and IVs for client &
server Notice that the seed is server random followed by client random (whereas
for master secret computation, it's client random followed by server random).
Sheesh!
 */
static void calculate_keys(TLSParameters *parameters) {
  ...
  int key_block_length =
      suite->hash_size * 2 + suite->key_size * 2 + suite->IV_size * 2;
  ...
  key_block_ptr =
      read_buffer(send_parameters->MAC_secret, key_block, suite->hash_size);
  key_block_ptr =
      read_buffer(recv_parameters->MAC_secret, key_block_ptr, suite->hash_size);
  key_block_ptr =
      read_buffer(send_parameters->key, key_block_ptr, suite->key_size);
  key_block_ptr =
      read_buffer(recv_parameters->key, key_block_ptr, suite->key_size);
  key_block_ptr =
      read_buffer(send_parameters->IV, key_block_ptr, suite->IV_size);
  key_block_ptr =
      read_buffer(recv_parameters->IV, key_block_ptr, suite->IV_size);
...
static void compute_master_secret(const unsigned char *premaster_secret,
  ...
  PRF(premaster_secret, premaster_secret_len, label, strlen(label),
      ...
      parameters->client_random, RANDOM_LENGTH * 2, parameters->master_secret,
...
static int send_client_hello(int connection, TLSParameters *parameters) {
  ...
  send_buffer_size = sizeof(ProtocolVersion) + sizeof(Random) +
                     sizeof(unsigned char) +
                     (sizeof(unsigned char) * package.session_id_length) +
                     sizeof(unsigned short) + (sizeof(unsigned short) * 1) +
                     sizeof(unsigned char) + sizeof(unsigned char);

  write_buffer = send_buffer = (char *)malloc(send_buffer_size);

  write_buffer =
      append_buffer(write_buffer, (void *)&package.client_version.major, 1);
  write_buffer =
      append_buffer(write_buffer, (void *)&package.client_version.minor, 1);
  write_buffer =
      append_buffer(write_buffer, (void *)&package.random.gmt_unix_time, 4);
  write_buffer =
      append_buffer(write_buffer, (void *)&package.random.random_bytes, 28);
  write_buffer =
      append_buffer(write_buffer, (void *)&package.session_id_length, 1);
  if (package.session_id_length > 0) {
    write_buffer = append_buffer(write_buffer, (void *)package.session_id,
                                 package.session_id_length);
  }
  write_buffer =
      append_buffer(write_buffer, (void *)&package.cipher_suites_length, 2);
  ...
  if (package.compression_methods_length > 0) {
    write_buffer =
        append_buffer(write_buffer, (void *)package.compression_methods, 1);
  }
...
static char *parse_server_hello(char *read_pos, int pdu_length,
                                TLSParameters *parameters) {
  ServerHello hello;

  read_pos =
      read_buffer((void *)&hello.server_version.major, (void *)read_pos, 1);
  read_pos =
      read_buffer((void *)&hello.server_version.minor, (void *)read_pos, 1);
  read_pos =
      read_buffer((void *)&hello.random.gmt_unix_time, (void *)read_pos, 4);
  // *DON'T* put this in host order, since it's not used as a time!  Just
  // accept it as is
  read_pos =
      read_buffer((void *)hello.random.random_bytes, (void *)read_pos, 28);
  ...
  read_pos =
      read_buffer((void *)&hello.compression_method, (void *)read_pos, 1);
  if (hello.compression_method != 0) {
    fprintf(stderr, "Error, server wants compression.\n");
    return NULL;
  }

  // TODO - abort if there's more data here than in the spec (per
  // section 7.4.1.2, forward compatibility note)
...
int rsa_key_exchange(rsa_key *public_key, unsigned char *premaster_secret,
 ...
 */
int dh_key_exchange(dh_key *server_dh_key, unsigned char *premaster_secret,
                    unsigned char **key_exchange_message) {
  huge Yc;
  huge Z;
  huge a;
...
static int send_client_key_exchange(int connection, TLSParameters *parameters) {
  ...
  switch (parameters->pending_send_parameters.suite) {
    ...
    case TLS_RSA_WITH_AES_256_CBC_SHA:
      ...
      key_exchange_message_len =
          rsa_key_exchange(&parameters->server_public_key.rsa_public_key,
    ...
    case TLS_DH_anon_WITH_AES_256_CBC_SHA:
      ...
      premaster_secret = malloc(premaster_secret_len);
      key_exchange_message_len = dh_key_exchange(
          &parameters->server_dh_key, premaster_secret, &key_exchange_message);
      break;
    default:
      return 0;
  }
...
void compute_handshake_hash(TLSParameters *parameters,
                            unsigned char *handshake_hash) {
...
static void compute_verify_data(const char *finished_label,
                                TLSParameters *parameters, char *verify_data) {
  ...
  PRF(parameters->master_secret, MASTER_SECRET_LENGTH, finished_label,
      strlen(finished_label), handshake_hash,
...
static int send_change_cipher_spec(int connection, TLSParameters *parameters) {
  ...
  memcpy(&parameters->active_send_parameters,
         &parameters->pending_send_parameters, sizeof(ProtectionParameters));
...
static int send_finished(int connection, TLSParameters *parameters) {
...
static unsigned char *parse_finished(unsigned char *read_pos, int pdu_length,
                                     TLSParameters *parameters) {
  unsigned char verify_data[VERIFY_DATA_LEN];
 ...
 * and allocate new space for the decrypted message (if decrypting is
 * "identity", then decrypted will point to encrypted).  The caller must always
 * issue a "free decrypted_message". Return the length of the message, or -1 if
 * the MAC doesn't verify.  The return value will almost always be different
 * than "encrypted_length", since it strips off the MAC if present as well as
 * bulk cipher padding (if a block cipher algorithm is being used).
 */
static int tls_decrypt(
    const unsigned char *header,  // needed for MAC verification
    unsigned char *encrypted_message, short encrypted_length,
    unsigned char **decrypted_message, ProtectionParameters *parameters) {
  ...
  *decrypted_message = (unsigned char *)malloc(encrypted_length);
  ...
  if (active_suite->bulk_decrypt) {
    active_suite->bulk_decrypt(encrypted_message, encrypted_length,
                               *decrypted_message, parameters->IV,
                               parameters->key);
  ...
  if (active_suite->new_digest) {
    ...
    hmac(parameters->MAC_secret, digest.hash_len * sizeof(int), mac_buffer,
         decrypted_length + 13, &digest);

    if (memcmp(digest.hash, (*decrypted_message) + decrypted_length,
...
/**
 * Read a TLS packet off of the connection (assuming there's one waiting) and
 * try to update the security parameters based on the type of message received.
 * If the read times out, or if an alert is received, return an error code;
 * return 0 on success.
 ...
 * section 7.3).  returns -1 if an error occurred (this routine will have sent
 * an appropriate alert). Otherwise, return the number of bytes read if the
 * packet includes application data; 0 if the packet was a handshake.  -1 also
 * indicates that an alert was received.
 */
static int receive_tls_msg(int connection, char *buffer, int bufsz,
                           TLSParameters *parameters) {
  ...
  if (parameters->unread_buffer != NULL) {
    ...
    if (recv(connection, header, 5, 0) <= 0) {
      // No data available; it's up to the caller whether this is an error or
      // not.
      return -1;
    }
    ...
    decrypted_length =
        tls_decrypt(header, encrypted_message, message.length,
  ...
  if (message.type == content_handshake) {
    ...
    while ((read_pos - decrypted_message) < decrypted_length) {
      ...
      read_pos =
          read_buffer((void *)&change_cipher_spec_type, (void *)read_pos, 1);
...
int tls_send(int connection, const char *application_data, int length,
             int options, TLSParameters *parameters) {
...
int tls_recv(int connection, char *target_buffer, int buffer_size, int options,
  ...
  bytes_decrypted =
      receive_tls_msg(connection, target_buffer, buffer_size, parameters);
